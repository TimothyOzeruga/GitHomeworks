...
$(function () {
  ...
  function getTeamInfo() {
    axios.get('assets/js/ourTeam.json').then(function (resp) {
      var li = '';
      resp.data.forEach(function (i) {
        ...
        li += '<ul class="soc_list">';
        i.soc_list.forEach(function (j) {
          li += " <li class=\"soc_item\"><a href=\"".concat(j.soc_link, "\" target=\"_blank\" rel=\"noopener\"><i class=\"").concat(j.icon, "\"></i></a></li>");
        });
        li += '</ul>';
        li += "</li>";
      });
